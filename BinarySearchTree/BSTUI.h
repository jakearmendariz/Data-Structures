 ...
 *
 * Assignment 4
 * This just holds all of the prompts
 * These constants will be used in the BSTClient soruce file for testig of code
 *
 */
...
#define ERR_NOT_DELETED "Could not find \"%s\" to delete\n"
